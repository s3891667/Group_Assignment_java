...
public class Data extends Main {
    ...
    private final int groupType, groupDay, metricsNum, resultType,displaytype;
    int total = 0;
    ...
    public void dataGroup() {
        if (groupType == 1) {
            ...
            if (metricsNum == 4) {
                if (resultType == 1) {
                    System.out.println(data_display.newtotal(finalList, total, cases_list));
                } else if (resultType == 2) {
                    System.out.println(data_display.upto(finalList, total, cases_list));
                }
